...
// every list-style subcommand in this package ("list", "members") against colDefs's column
// table, and returns the bound Columns/SortBy flag values for the caller to store.
