...
// it nor internal/repository nor internal/commit imports internal/branch, so importing testutil
// from this internal ("package branch") test package does not cycle -- unlike internal/repository
// and internal/workspace's own test files, which need a local harness instead (see those packages'
// helpers_test.go).
